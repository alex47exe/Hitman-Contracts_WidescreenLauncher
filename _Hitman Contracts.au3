...
#AutoIt3Wrapper_Outfile=_Hitman Contracts.exe
...
Func _Custom_Code()
	...
	; custom code for 'Hitman: Contracts'
	$Ini2 = @ScriptDir & "\h3.ini"
	$desktop_width = IniRead($Ini, "Custom", "desktop_width", 0)
	$desktop_height = IniRead($Ini, "Custom", "desktop_height", 0)
